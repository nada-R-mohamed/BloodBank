...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-info">
        ...
        <!-- form start -->
        <form class="form-horizontal" action="<?php echo e(route('posts.update',$post->id)); ?>" method="post"
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="title" class="form-control" value="<?php echo e(old('title',$post->title)); ?>"
                    ...
                    <div class="col-sm-10">
                        <select name="category_id" class="form-control form-select">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option
                                    value="<?php echo e($category->id); ?>" <?php if(old('category_id' , $post->category_id) == $category->id): echo 'selected'; endif; ?> ><?php echo e($category->name); ?></option>
